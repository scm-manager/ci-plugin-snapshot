...
const API_JOBS = "https://oss.cloudogu.com/jenkins/job/scm-manager/job/scm-manager-bitbucket/api/json"
...
func downloadPlugin(directory string, job Job, branch string) (Plugin, error) {
  ...
  for _, artifact := range build.Artifacts {
    downloadArtifact(directory, job, branch, artifact)
...
func downloadArtifact(directory string, job Job, branch string, artifact Artifact) {
